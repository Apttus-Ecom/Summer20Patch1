                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            ...
                            <li class="link">
                                <a href="modules/LineItemTableRowModule.html" data-type="entity-link">LineItemTableRowModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-LineItemTableRowModule-074409308472a9989ede4222d2973b59"' : 'data-target="#xs-components-links-module-LineItemTableRowModule-074409308472a9989ede4222d2973b59"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-LineItemTableRowModule-074409308472a9989ede4222d2973b59"' :
                                            'id="xs-components-links-module-LineItemTableRowModule-074409308472a9989ede4222d2973b59"' }>
                                            <li class="link">
